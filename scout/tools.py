...
class ServerSession:
    """Persists the database engine and query results across tool calls."""
    def __init__(self):
    ...
    def _get_engine(self):
        if self.engine is None:
            ...
            _engine = create_engine(
                ...
                connect_args={
                    "application_name": "delishes_agent",
